...
def display_specific_designations(df):
    ...
    suppliers = {
        ...
        "ASICS": ["GEL TRABUCO 12 GTX", "GEL-CUMULUS 27", "GEL-CUMULUS 27 W", "GT-2000 13 TR", "GT-2000 13 TR W", "GT-2000 13 W", "MAGIC SPEED 4", "METASPEED EDGE+", "NOVABLAST 5", "NOVABLAST 5 W"],
    }
